"""
Django settings for clms project.
...
SECRET_KEY = 'django-insecure-s2&0$0(q17_5wo&iy=k==4$qmnst@k8g@cvlf0k#plv=qh9)o1'
...
WSGI_APPLICATION = 'clms.wsgi.application'
